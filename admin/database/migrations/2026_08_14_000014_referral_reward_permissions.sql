...
--
-- 背景：新增 ReferralRewardController（返佣记录只读列表），/admin 组新增
-- 1 条路由 GET /admin/referral-rewards。AdminPermission 中间件按 method.path
-- 精确匹配，本迁移补齐权限条目，并给超级管理员角色授予全部新权限。
-- id 接续 2026_08_14_000013 积分兑换商城的 378，下一个 379。
-- ============================================================
