// weapp-qrcode (vendored from github.com/yingye/weapp-qrcode, MIT)
// QRCode core: (c) 2009 Kazuhiko Arase, MIT
...
// inline extend (deep merge) — vendored from npm 'extend' subset
function extend(deep, target, source) {
  if (deep) {
    for (var key in source) {
      var v = source[key];
      if (v && typeof v === 'object') {
        target[key] = extend(deep, (target[key] && typeof target[key] === 'object') ? target[key] : {}, v);
      } else {
        target[key] = v;
      }
    }
