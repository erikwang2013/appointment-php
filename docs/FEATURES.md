...
Flutter Web 单页应用，共 21 个页面：dashboard/用户/角色/配置/日志/核销/排班/服务/技师/订单/优惠券/会员/次卡/公告/FAQ/提现/评价/报表/售后/门店工作台/个人中心。

### 1. 首页仪表盘

- 统计卡 7 项：用户总数/今日新增/活跃用户/操作日志/今日预约/待审核提现/待审技师（动态渲染）
- 近 30 天趋势折线图：订单量/金额/新增用户/活跃度
- 用户状态分布饼图：启用/禁用
- 最近操作日志：最近 10 条
- 快速导航：待处理模块按钮
- 站内消息：新订单通知/退款通知
...
- ReportController 3 端点：订单统计（汇总+按天趋势）/ 技师TOP10业绩 / 渠道分布（支付渠道+订单状态）
