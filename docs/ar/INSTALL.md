...
| MySQL | 8.0+ | بادئة الجداول `erik_`، مجموعة الأحرف utf8mb4 |
...
|----|------|--------|
| لوحة الإدارة | 8 | `erik_admin_user`, `erik_admin_role`, `erik_admin_permission`, `erik_operation_log` |
| مجال المستخدم | 4 | `erik_user`, `erik_user_address`, `erik_user_favorite`, `erik_user_device` |
| مجال الفني | 8 | `erik_technician_profile`, `erik_technician_schedule`, `erik_technician_earning`, `erik_technician_withdrawal`, `erik_technician_tier_config` |
| مجال الخدمة | 4 | `erik_service_category`, `erik_service`, `erik_service_package`, `erik_service_record` |
| مجال الطلب | 5 | `erik_order`, `erik_order_item`, `erik_order_payment`, `erik_order_refund`, `erik_order_review` |
| مجال التسويق | 8 | `erik_coupon`, `erik_member_card`, `erik_gift_card`, `erik_user_points`, `erik_promotion` |
| الطابور | 1 | `erik_queue_number` |
| مجال المحتوى | 5 | `erik_banner`, `erik_announcement`, `erik_faq`, `erik_feedback`, `erik_platform_agreement` |
| مجال المجتمع | 3 | `erik_post`, `erik_comment`, `erik_moment` |
| المتاجر | 1 | `erik_store` |
| التدريب | 2 | `erik_training_course`, `erik_training_progress` |
| الامتحانات | 3 | `erik_exam`, `erik_exam_question`, `erik_exam_attempt` |
| النظام | 3 | `erik_system_config`, `erik_notification`, `erik_signature` |
| **الإجمالي** | **55** | |

جميع الجداول تستخدم البادئة `erik_`، والمفتاح الأساسي `id` من نوع BIGINT غير تلقائي (يولَّد من snowflake-php على مستوى التطبيق).
