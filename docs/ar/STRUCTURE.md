# نظام خدمات الحجز — هيكل المشروع
> **Languages**: [中文](../STRUCTURE.md) · [English](../en/STRUCTURE.md) · [한국어](../ko/STRUCTURE.md) · [Русский](../ru/STRUCTURE.md) · [Deutsch](../de/STRUCTURE.md) · [Français](../fr/STRUCTURE.md) · [Español](../es/STRUCTURE.md) · [Português](../pt/STRUCTURE.md) · [हिन्दी](../hi/STRUCTURE.md) · [বাংলা](../bn/STRUCTURE.md) · [Bahasa Indonesia](../id/STRUCTURE.md) · [日本語](../ja/STRUCTURE.md)
...
### apps/wechat/ — برنامج WeChat الصغير
...
| الخدمة | الاستخدام | نقطة الربط |
|------|------|--------|
| منصة WeChat المفتوحة | تسجيل دخول WeChat/UnionID | WechatAuthService |
| WeChat Pay | الدفع/الاسترداد/السحب | WechatPayService |
| مزود الرسائل النصية | رمز التحقق/الإشعارات | SmsService |
| خدمة الخرائط | تحديد المواقع LBS/الملاحة/حساب المسافة | MapService |
