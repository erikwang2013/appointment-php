...
| মেথড | পাথ | বিবরণ |
|------|------|------|
| GET | `/api/seckill` | সেকিল অ্যাক্টিভিটি তালিকা (status=1 এবং টাইম উইন্ডোর মধ্যে; বিক্রি হওয়া সংখ্যা = appointment_order.seckill_id অর্ডার সংখ্যা, অবশিষ্ট স্টক সহ) |
