...
| টেকনিশিয়ান রিভিউ রিপ্লাই | POST /api/technician/review/reply/{order_id}: অ-নিজস্ব ৪০৪, পুনরাবৃত্তি রিপ্লাই ৪২২, রিপ্লাই সফলে ব্যবহারকারীকে সাইট-ইন নোটিফিকেশন; appointment_order_review-এ replied_at; admin রিপ্লাই ডিটেইল (পারমিশন ৩৮১) |
...
| রিভিউ অ্যাপেন্ড | POST /api/order/review/{order_id}/append: অ-নিজস্ব ৪০৪/পুনরাবৃত্তি ৪২২/খালি কনটেন্ট ৪২২/অ-কমপ্লিটেড ৪২২, সফলে টেকনিশিয়ানকে সাইট-ইন নোটিফিকেশন type='review_append'; appointment_order_review-এ append_content/append_images(JSON)/append_at; সাথে রেজিস্টার্ড ব্যবহারকারীর রিভিউ রুট (আগে store রুট ছিল না) এবং এর লুকানো TypeError ফিক্স |
...
| অ্যাপয়েন্টমেন্ট ক্যালেন্ডার | GET /api/calendar/technician/{id} (মাস ভিউ) + /day (দিন ভিউ): time_slots JSON ঘণ্টা স্লটে বিস্তৃত, appointment_order-এ আগে থেকে বুক করা স্লট বাদ; শাখা শিডিউল ভিজুয়ালাইজড সময় নির্বাচন |
| ব্যবহারকারী গ্রোথ লেভেল | appointment_user_growth + appointment_growth_level (ব্রোঞ্জ ০/সিলভার ১০০/গোল্ড ৫০০/প্লাটিনাম ২০০০/ডায়মন্ড ৫০০০); চেক-ইন +১০, রিভিউ +২০, খরচ প্রতি ১ ইউয়ানে ১ পয়েন্ট (বিদ্যমান স্টেট পুনঃযাচাই প্রাকৃতিক আইডেম্পোটেন্ট); GET /api/growth (ওভারভিউ/records/levels পাবলিক লেভেল) |
