...
| আইটেম | ফিক্স বিবরণ |
|----|---------|
| অর্ডার টেম্পারিং রোধ | OrderController::store() অর্ডার আইটেমের দাম সবসময় ডেটাবেস রেকর্ড অনুযায়ী (service→erik_service、product→erik_product), ক্লায়েন্টের দাম হিসাবে ধরা হয় না; অজানা target_type ৪২২; target_id অবশ্যই hashid (raw id ডিকোড 0 → ৪২২「商品不存在或已下架」); গ্রুপ বাই/সেকিল দামও DB অনুযায়ী |
