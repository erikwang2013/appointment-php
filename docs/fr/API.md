...
| Méthode | Chemin | Description |
|------|------|------|
| GET | `/api/seckill` | Liste des activités flash (status=1 et dans la fenêtre de temps ; contient la quantité vendue = nombre de commandes appointment_order.seckill_id, stock restant) |
