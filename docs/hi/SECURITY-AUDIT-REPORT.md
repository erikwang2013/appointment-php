...
| आइटम | सुधार सामग्री |
|----|---------|
| ऑर्डर टैम्पर-रोधी | OrderController::store() में ऑर्डर आइटम कीमतें हमेशा डेटाबेस रिकॉर्ड के अनुसार (service→erik_service, product→erik_product), क्लाइंट कीमत गणना में भाग नहीं लेती; अज्ञात target_type 422; target_id अनिवार्य hashid (raw id डिकोड होकर 0 → 422 "उत्पाद मौजूद नहीं या अनलिस्टेड"); समूह खरीद/सेकिल कीमत भी DB आधारित |
