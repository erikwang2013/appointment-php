...
## 2. Ciclo de vida do cartão de membro
...
## 3. Ciclo de vida da adesão de técnico
...
## 5. Ciclo de vida do levantamento do técnico
...
## 6. Ciclo de vida da autenticação Token
...
## 7. Ciclo de vida da atividade de compras em grupo
...
## 8. Ciclo de vida da oferta de cupões
...
## 9. Ciclo de vida da expiração de pontos
...
## 10. Ciclo de vida de transferências (ronda 19: transferência de saldo + oferta de pontos)
...
## 11. Ciclo de vida do ticket de apoio ao cliente (ronda 20)
...
## 12. Ciclo de vida da fatura eletrónica (ronda 20)
...
## 13. Ciclo de vida da atividade de desconto direto (ronda 22)
...
## 15. Ciclo de vida do sorteio da roda da sorte (ronda 23)
...
## 14. Ciclo de vida da eliminação de conta (ronda 22)
...
## 16. Ciclo de vida da atividade de venda relâmpago (ronda 24)
...
## 17. Ciclo de vida da recompensa de cliente recorrente (ronda 24)
