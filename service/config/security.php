 ...
 *
 * 基于 erikwang2013/security-php v1.0+
...
return [
    ...
    'detectors' => [
        ...
        'http_method'       => ['enabled' => true, 'mode' => 'block', 'allowed_methods' => ['GET', 'POST', 'PUT', 'DELETE', 'HEAD', 'OPTIONS', 'PATCH']],
        'body_size'         => ['enabled' => true, 'mode' => 'block', 'max_size' => 10485760],
        'content_type'      => ['enabled' => true, 'mode' => 'block', 'allowed_types' => ['application/x-www-form-urlencoded', 'multipart/form-data', 'application/json', 'text/plain', 'application/xml', 'text/xml']],
        'csrf_origin'       => ['enabled' => true, 'mode' => 'block', 'allowed_origins' => []],
    ],
